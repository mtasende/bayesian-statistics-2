...
inits = function() {
    inits = list("mu"=rnorm(51,0.0,100.0), "prec"=rgamma(1,1.0,1.0))
}
...
summary(mod_sim) # Result: [1.0094, 1.0487]
dat_uy = dat[dat$symbol=='UYU',]
dat_uy_now = dat_uy[nrow(dat_uy),]
dat_uy_base = dat_uy[dat_uy$date=='2010-08-15',]
ex_min = dat_uy_base$exchange_rate * 1.0094 * dat_uy_now$cpi_usa / dat_uy_now$cpi
ex_max = dat_uy_base$exchange_rate * 1.0487 * dat_uy_now$cpi_usa / dat_uy_now$cpi
1/ex_min
1/ex_max
